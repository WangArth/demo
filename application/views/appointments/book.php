...
<div id="main" class="container">
    <div class="row wrapper">
        <div id="book-appointment-wizard" class="col-12 col-lg-10 col-xl-8">
            ...
            <div id="header">
                <span id="company-name"><img src="https://clientedigital.com.mx/zonabigotes/images/logoBigotes_citas.png" style="border-radius: 100px; text-align: center"> <b></b>Zona Bigotes</b></span>

                <!-- <div id="steps">
                    <div id="step-1" class="book-step active-step"
                         data-tippy-content="<?= lang('service_and_barber') ?>">
                        <strong>1</strong>
                    </div>
            ...
            <!-- <div id="wizard-frame-1" class="wizard-frame"> -->
                <div class="frame-container">
                    <h2 class="frame-title">Seleccione el Servicio y Barbero<!--<?= lang('service_and_provider') ?>--></h2>
                        ...
                        <div class="col">
                            ...
                            <div class="form-group">
                                <label for="select-provider">
                                    <strong>Barbero <!-- <?= lang('provider') ?> --></strong>
                                </label>
                        ...
                        <div class="col-12 col-md-6">
                            <div id="select-time">
                                <div class="form-group" style="display: none">
                                    <label for="select-timezone" style="display: none"><?= lang('timezone') ?></label>
                    ...
                    <div class="row frame-content">
                        <div class="col-12 col-md-6">
                            ...
                            <div class="form-group" style="display: none">
                                ...
                                <input value="-" type="text" id="last-name" class="required form-control" maxlength="120"/>
                            </div>
                            <div class="form-group" style="display: none">
                                ...
                                <input value="gg@hotmail.com" type="hidden" id="email" class="required form-control" maxlength="120"/>
                            </div>
                            <div class="form-group">
            ...
            <div id="frame-footer">
                <small>
                    <span class="footer-powered-by">
                        ...
                        <a href="https://clientedigital.com.mx" target="_blank">ClienteDigital.com</a>
                    </span>
